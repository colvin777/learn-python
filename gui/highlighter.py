...
class PythonHighlighter(QSyntaxHighlighter):
    ...
    def __init__(self, parent=None):
        ...
        KEYWORDS = ["module", "submodule", "typedef", "container", "leaf",
                "leaf-list", "list", "choice", "anyxml", "grouping", "uses",
                "rpc", "notification", "augment", "identity", "extension", "belong-to",
                "import", "include", "path", "reference", "revision", "description", "base",
                "namespace", "prefix", "organization", "status", "key", "mandatory",
                "default", "if-feature", "feature", "value", "enum", "config", "units"]
